    ...
    try {
      ...
      if (data.token) {
        ...
        if (response.status === 200) {
          toast.success(`Welcome Back ${data.name}`, toastify);
        } 
        history.push("/dashboard");
      } else{
        toast.error("Invalid Credentials", toastify);
      }
    } catch (error) {
      ...
      <div class="py-6">
        <div class="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
          ...
          <div class="w-full p-8 lg:w-1/2">
            ...
            <div class="mt-8">
              <button onClick={loginUser} class="bg-gray-700 text-white font-bold py-2 px-4 w-full rounded hover:bg-gray-600">
                Login
              </button>
            </div>
            <div class="mt-4 flex items-center justify-between">
              ...
              <a
                ...
                class="text-xs text-gray-500 uppercase hover: cursor-pointer"
              >
                or sign up
              </a>
              <span class="border-b w-1/5 md:w-1/4"></span>
